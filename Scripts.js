...
<body>
    ...
    <section class="hero">
        <div class="content">
            ...
            <a href="#" class="cta-button" id="startButton">Comece Agora</a>
        </div>
        <div class="image">
    ...
    <script>
        // Adiciona alerta de boas-vindas ao clicar no botão "Comece Agora"
        document.getElementById('startButton').addEventListener('click', function() {
            alert('Bem-vindo à Consultoria Pro! Estamos prontos para ajudar você.');
        });

        // Função para fazer o scroll suave ao clicar em links de navegação
